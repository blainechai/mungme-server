                    ...
                    <%--<div class="panel">--%>
                        ...
                        <%--<div class="tab-content">--%>
                            <%--<div class="tab-pane active well" id="profile">--%>
                                <%--<h4><i class="glyphicon glyphicon-user"></i></h4> Lorem profile dolor sit amet,--%>
                                <%--consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate.--%>
                                <%--<p>Quisque mauris augue, molestie tincidunt condimentum vitae, gravida a libero. Aenean--%>
                                    <%--sit amet felis dolor, in sagittis nisi.</p>--%>
                            <%--</div>--%>
                            <%--<div class="tab-pane well" id="messages">--%>
                                <%--<h4><i class="glyphicon glyphicon-comment"></i></h4> Message ipsum dolor sit amet,--%>
                                <%--consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate.--%>
                                <%--<p>Quisque mauris augu.</p>--%>
                            <%--</div>--%>
                            <%--<div class="tab-pane well" id="settings">--%>
                                <%--<h4><i class="glyphicon glyphicon-cog"></i></h4> Lorem settings dolor sit amet,--%>
                                <%--consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate.--%>
                    ...
                    <%--<div class="panel panel-default">--%>
                        ...
                        <%--<div class="panel-body">--%>
                            <%--<div class="alert alert-info">--%>
                                <%--<button type="button" class="close" data-dismiss="alert">횞</button>--%>
                                <%--This is a dismissable alert.. just sayin'.--%>
                            <%--</div>--%>
                            <%--<p>This is a dashboard-style layout that uses Bootstrap 3. You can use this template as a--%>
                                <%--starting point to create something more unique.</p>--%>
                            <%--<p>Visit the Bootstrap Playground at <a href="http://bootply.com">Bootply</a> to tweak this--%>
                                <%--layout or discover more useful code snippets.</p>--%>
                        <%--</div>--%>
                    <%--</div>--%>
