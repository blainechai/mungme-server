...
<head>
    ...
    <link rel="stylesheet" href="/css/bootstrap-org.css">
    ...
    <script type="application/javascript" src="/js/bootstrap-org.js"></script>
</head>
<body>
<!-- Split button -->
<div id="header" class="header" style="height: 212px;position: relative;">
    ...
    <div class="header-menu">
        ...
        <div class="header-btn" style="text-align: center;"><img src="/imgs/header-reserve-btn.png" style="width: 46px;"><div class="header-btn-title" style="width: 100%; text-align: center;">예약관리</div></div><div class="header-menu-separator"></div>
