...
<div id="header" class="header" style="height: 212px;position: relative;">
    ...
    <div class="header-menu-container">
        <div class="header-menu">
            ...
            <div class="header-btn header-reservation-btn" style="width: calc(14.285714285714285% - 2px);"><img
                    src="/imgs/header-reservation-btn.png"
                    style="width: 46px;">
                <div class="header-btn-title" style="width: 100%; text-align: center;">예약관리</div>
            </div>
            <div class="header-menu-separator"></div>
            <div class="header-btn header-shop-btn" style="text-align: center;"><img
                    src="/imgs/header-shop-btn.png" style="">
                <div class="header-btn-title" style="width: 100%; text-align: center;">매장관리</div>
            </div>
            <div class="header-menu-separator"></div>
            <div class="header-btn header-customer-btn" style="text-align: center;"><img
                    src="/imgs/header-customer-btn.png"
                    style="width: 50px;">
                <div class="header-btn-title" style="width: 100%; text-align: center;">고객관리</div>
            </div>
            <div class="header-menu-separator"></div>
            <div class="header-btn header-sale-btn" style="text-align: center;"><img src="/imgs/header-sale-btn.png"
                                                                                     style="width: 38px;">
                <div class="header-btn-title" style="width: 100%; text-align: center;">입출금관리</div>
            </div>
            <div class="header-menu-separator"></div>
            <div class="header-btn header-cs-btn" style="text-align: center;"><img src="/imgs/header-cs-btn.png"
                                                                                   style="width: 40px;">
                <div class="header-btn-title" style="width: 100%; text-align: center;">고객센터</div>
            </div>
            <div class="header-menu-separator"></div>
            <div class="header-btn header-analysis-btn" style="text-align: center;"><img
            ...
            <div class="header-menu-separator"></div>
            <div class="header-btn header-config-btn" style="text-align: center;"><img
